				...
				<div class="manage_hotel_add_form textbox">
					...
					<div class="convenience mb40">
						<div class="manage_kitchen ml20">
							...
							<div class="manage_hotel_add_answer_s"><input type="checkbox"  class="checkbox h_convenience" name="convenience" value="무선인터넷">주방</div>
							...
							<div class="manage_hotel_add_answer_s"><input type="checkbox"  class="checkbox h_convenience" name="convenience" value="식기류">식기류</div>
							<div class="manage_hotel_add_answer_s"><input type="checkbox"  class="checkbox h_convenience"  name="convenience" value="기본조리도구">기본조리도구</div>
							<div class="manage_hotel_add_answer_s"><input type="checkbox"  class="checkbox h_convenience"  name="convenience" value="가스레인지또는인덕션">가스레인지 또는 인덕션</div>
						</div>
