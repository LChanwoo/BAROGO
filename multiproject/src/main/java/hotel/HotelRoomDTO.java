...
public class HotelRoomDTO {
	...
	public int getRoom_bed_qty() {
		return room_bed_qty;
	}

	public void setRoom_bed_qty(int room_bed_qty) {
	...
	public HotelRoomDTO(String hotel_id, String room_name, String room_bed_size, int room_bed_qty,
